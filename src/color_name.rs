//! Vendored CSS color-name table.
//!
//! A behavior-faithful copy of the npm [`color-name`](https://www.npmjs.com/package/color-name)
//! `2.1.0` table that `color-convert@3.1.3` depends on. Vendored as a static
//! Rust lookup table (data, not a crate dependency) so the `keyword` routes are
...
pub static CSS_COLORS: [(&str, [u8; 3]); 148] = [
